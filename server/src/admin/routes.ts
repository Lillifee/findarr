...
const adminRoutes: FastifyPluginAsync = async fastify => {
  ...
  fastify.post('/users', r =>
    createUser(fastify.db, CreateUserSchema.parse(r.body))
  );
  fastify.delete(
    '/users/:id',
    protectedRoute(r =>
  ...
  fastify.get('/radarr/quality-profiles', () =>
    fastify.radarr.listQualityProfiles()
  );
  ...
  fastify.get('/sonarr/quality-profiles', () =>
    fastify.sonarr.listQualityProfiles()
  );
