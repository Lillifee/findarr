...
// Derive setting keys from the schema types
...
// Extract keys arrays from schemas
...
/** Read a subset of settings, returning a typed record with null for missing keys. */
...
/** Write settings, skipping any keys whose value is undefined. */
